...
Inside the `pdf-outline` directory, clone `pindf`, which is a low-level pdf parser library.
...
Create a `build` directory inside `pdf-outline`, and then run cmake & make
